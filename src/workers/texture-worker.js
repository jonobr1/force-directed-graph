...
async function processTextures(data) {
  ...
  try {
    ...
    try {
      ...
      new Uint8Array(wasmMemory, nodesDataPtr, nodesDataSize).set(new Uint8Array(nodesBuffer.buffer));
      new Uint8Array(wasmMemory, linksDataPtr, linksDataSize).set(new Uint8Array(linksBuffer.buffer));
